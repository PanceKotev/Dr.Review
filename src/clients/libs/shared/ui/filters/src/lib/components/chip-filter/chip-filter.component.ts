import { IOptionItem } from '@drreview/shared/data-access';
...
export class ChipFilterComponent  extends BaseControlValueAccessor<string>{
  @Input()
  public filterOptions: IOptionItem[] = [];
}
